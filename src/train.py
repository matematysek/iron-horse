...
class EngineConsist(Consist):
    ...
    def __init__(self, **kwargs):
        ...
        # temp
        alternative_livery_name = kwargs.get("alternative_liveries", [None])[0]
        alternative_liveries = self.roster.livery_presets.get(alternative_livery_name, None)
...
class Train(object):
    ...
    def requires_colour_mapping_cb(self):
        ...
        if getattr(self.consist, "use_colour_randomisation_strategies", False):
            ...
            if self.consist.gestalt_graphics.alternative_liveries is not None:
